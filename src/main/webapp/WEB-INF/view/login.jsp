...
<div class="htmleaf-container">
    ...
    <div id="js-modal-holder" class="modal-holder">
      ...
      <form action="${pageContext.request.contextPath}users/login" id="js-modal" class="modal">
        ...
        <div class="modal__description">欢迎登录</div>
        ...
        <div class="modal__section grid grid--sliced grid--gutter-x2">
          ...
          <div class="grid-bit grid-bit--1-2" style="font-size:10px;margin-top:10px;">
            <a href="${pageContext.request.contextPath }/register" style="color:#999;">没有账号！注册</a> 
          </div>
        </div>
      </form>
